...
class NewsScraper:
    ...
    def scrape_site(self, url, country, source, item_selector, title_selector, link_selector=None):
        try:
            ...
            for item in items[:15]:
                ...
                l_tag = item.select_one(link_selector) if link_selector else item.find('a') if hasattr(item, 'find') else None
    ...
    def run_all(self):
        ...
        # KAZAKHSTAN
        self.scrape_site("https://tengrinews.kz/", "Kazakhstan", "Tengrinews", ".main-news_top_item, .main-news_column_item", "span")
...
if __name__ == "__main__":
    scraper = NewsScraper("unified_news_topic")
